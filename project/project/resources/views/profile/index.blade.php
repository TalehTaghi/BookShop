                ...
                <div class="content content-full">
                    <div class="py-5 text-center">
                        <a class="img-link" href="#">
                            <img class="img-avatar img-avatar96 img-avatar-thumb" src="{{ asset(\Illuminate\Support\Facades\Auth::user()->img) }}" alt="">
                        </a>
                        ...
                        <div class="row push">
                            <div class="col-lg-4" style="margin: auto">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="dm-profile-edit-username" disabled="disabled" value="{{ \Illuminate\Support\Facades\Auth::user()->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="dm-profile-edit-name">Email</label>
                                    <input type="text" class="form-control" id="dm-profile-edit-name" disabled="disabled" value="{{ \Illuminate\Support\Facades\Auth::user()->email }}">
                                </div>
                                <div class="form-group">
                                    <label>Your Avatar</label>
                                    <div class="push">
                                        <img class="img-avatar" src="{{ asset(\Illuminate\Support\Facades\Auth::user()->img)  }}" alt="">
                                    </div>
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="dm-profile-edit-avatar">Profil Şəklini dəyiş</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4" style="margin: auto">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <input type="password" class="form-control" id="dm-profile-edit-password-new-confirm" name="new_password_confirm">
                                    </div>
                                </div>
                            </div>
                        </div>
