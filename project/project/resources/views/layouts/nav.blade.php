            ...
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ route('contactsIndex') }}">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="{{ route('customersList') }}">
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="#">
                                <span class="nav-main-link-name">Ləğv ediləm</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="#">
