                        ...
                        <div class="row push">
                            <div class="col-lg-12 col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="default_title" name="default_title" value="{{ $data[0]->default_title }}" />
                                </div>
                                <div class="form-group">
                                    <label for="default_description">Açıqlama</label>
                                    <input type="text" class="form-control" id="default_description" name="default_description" value="{{ $data[0]->default_description }}" />
                                </div>
                                <div class="form-group">
                                    <label for="default_keywords">Açar Sözlər</label>
                                    <input type="text" class="form-control" id="default_keywords" name="default_keywords" value="{{ $data[0]->default_keywords }}" />
                                </div>
