                            ...
                            @foreach($data as $slider)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-outline-danger" onclick="SliderDelete({{ $slider->id }})">Sil</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('sliderEdit') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="edit_id_slider" id="edit_id_slider" />
                        <div class="form-group">
                            <label for="edit_name_slider" class="col-form-label">Adı:</label>
                            <input type="text" class="form-control" name="edit_name_slider" id="edit_name_slider">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="edit_status_slider" class="col-form-label">Status:</label>
                            <select name="edit_status_slider" id="edit_status_slider" class="form-control">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" data-toggle="custom-file-input" id="dm-profile-edit-avatar" name="image_edit">
                            <label class="custom-file-label" for="dm-profile-edit-avatar">Şəkil Seç</label>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Bağla</button>
