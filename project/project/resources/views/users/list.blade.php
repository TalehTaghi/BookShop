        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">İstifadəçilərim</h1>
                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-info" onclick="UserUpdateView({{ $user->id }})">Redaktə Et</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <form method="POST" action="{{ route('userEdit') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-9">
                                <input type="text" class="form-control" id="edit_password" name="edit_password" placeholder="Şifrə" />
                            </div>
                            <div class="form-group col-md-3">
                                <button type="button" class="btn btn-outline-danger" onclick="makePassword()">Şifrə qur</button>
                            </div>
                        </div>
